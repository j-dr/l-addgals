...
dir = '/nfs/slac/g/ki/ki11/des/mbusha/catalogs/Carmen/Octant/v4.40/v15/'
...
coefs[0] -= 1.5 ;;;definitely ~1 mag too shallow relative to 22.29 r-band limit
...
table = generate_z_of_r_table(omegam, omegal, zmax = sim_zmax*1.5)
nzbins = 2000
zarr = fltarr(nzbins)
ng = fltarr(nzbins)
ng_bin = fltarr(nzbins)
delz = (sim_zmax*1.1-sim_zmin)/nzbins
...
ldarr = ['060', '065', '068', '070', '072', '075', '078', '080', '082', '085', '088', '090', '095', '097', '098', '099']
...
for i = 0, nproc - 1 do begin
   ...
   if (1) then begin ;doing the AGES parameterization
     denspdfstr = ' /u/ki/mbusha/projects/modules/idl/addgals/rdel/denspdf_Consuelo_passive_scatter0.20_histograms_individual_params_'+LDnum[i]+'.dat'
     lbcgstr = ' /u/ki/mbusha/projects/modules/idl/addgals/rdel/lbcg_mvir_Consuelo_passive_scatter0.20_histograms_'+LDnum[i]+'.txt'
